...
/* 
    Use forEach method to loop though all the elements in the 'numbers' array above, and divide 
    each element (number) by 2. Print the result in console.
*/
...
const cities2 = cities.filter((city) => city.endsWith('i'))
console.log(cities2)
...
/* 
    Using forEach method, identify each element of the 'fruits' array above if it's 
    an apple or orange by its color. If the color is red, print "The fruit with 
    index [THE ELEMENT'S INDEX] is an apple." If the color is orange, print "The fruit with 
    index [THE ELEMENT INDEX] is an orange." If the color is not red or apple, print "The fruit 
...
fruits.forEach((fruit) => {
  if (fruit.color === 'orange') {
    console.log(`The fruit with the index ${fruits.indexOf(fruit)} is an orange.`)
  }
  else if (fruit.color === 'red') {
    console.log(`The fruit with the index ${fruits.indexOf(fruit)} is an apple.`)
  } else {
    console.log(`The fruit with the index ${fruits.indexOf(fruit)} is neither apple or orange.`)
  }
})
